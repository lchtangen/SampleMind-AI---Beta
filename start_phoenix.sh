...
if command -v sm &> /dev/null; then
    ...
    sm --version 2>/dev/null || echo "SampleMind AI Phoenix Beta v2.0"
    echo ""
    ...
    echo -e "     ${BLUE}sm analyze sample.wav${NC}"
    echo ""
    echo -e "  ${GREEN}2.${NC} Import your samples:"
    echo -e "     ${BLUE}sm import folder ~/Music/Samples${NC}"
    echo ""
    echo -e "  ${GREEN}3.${NC} Auto-tag with AI:"
    echo -e "     ${BLUE}sm tag auto kick.wav${NC}"
    echo ""
    echo -e "  ${GREEN}4.${NC} Get help anytime:"
    echo -e "     ${BLUE}sm --help${NC}"
    echo ""
