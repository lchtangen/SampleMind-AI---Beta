...
def test_integrated_pipeline():
    ...
    engine.feature_extractor.extract_tonal_features = MagicMock(
        return_value={
            "chroma_features": [],
            "key": "C",
            "mode": "major",
    ...
    engine.feature_extractor.extract_rhythmic_features = MagicMock(
        return_value={
            "tempo": 120,
            "beats": [],
            "onset_times": [],
    ...
    engine.feature_extractor.extract_spectral_features = MagicMock(
        return_value={
            "spectral_centroid": [],
            "spectral_bandwidth": [],
            "spectral_rolloff": [],
