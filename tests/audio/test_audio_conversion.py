...
class TestAudioConversion:
    ...
    def test_sample_rate_conversion(self, processor, audio_file, tmp_path):
        ...
        for rate in target_rates:
            ...
            processor.convert_audio(src_path, output_path=output_path, sample_rate=rate)
    ...
    def test_bit_depth_conversion(self, processor, audio_file, tmp_path):
        ...
        for depth in BitDepth:
            ...
            processor.convert_audio(src_path, output_path=output_path, bit_depth=depth)
    ...
    def test_channel_conversion(self, processor, audio_file, tmp_path):
        ...
        processor.convert_audio(
            src_path, output_path=mono_path, channels=ChannelMode.MONO
        )
        ...
        processor.convert_audio(
            src_path, output_path=stereo_path, channels=ChannelMode.STEREO
        )
    ...
    def test_invalid_bit_depth(self, processor, audio_file, tmp_path):
        ...
        with pytest.raises(ValueError):
            processor.convert_audio(
                src_path, output_path=output_path, bit_depth=8  # Unsupported bit depth
            )
    ...
    def test_file_like_object(self, processor, audio_file, tmp_path):
        ...
        with open(src_path, "rb") as f_in:
            processor.convert_audio(
                f_in, output_path=output_path, output_format=AudioFormat.WAV
            )
        ...
        with open(output_path, "wb") as f_out:
            processor.convert_audio(
                src_path, output_path=f_out, output_format=AudioFormat.WAV
            )
