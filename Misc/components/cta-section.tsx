    ...
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.2" stopColor="#0A0A0F" stopOpacity="0.8" />
              <stop offset="0.8" stopColor="#0A0A0F" stopOpacity="0.8" />
            ...
            >
              <stop offset="0.1294" stopColor="#8B5CF6" />
              <stop offset="0.2347" stopColor="#3B82F6" />
              <stop offset="0.3" stopColor="#10B981" stopOpacity="0" />
            </radialGradient>
            <linearGradient
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-4xl md:text-5xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[435px] neon-text">
        ...
        <Link href="https://vercel.com/home" target="_blank" rel="noopener noreferrer">
          <Button
            className="px-[30px] py-2 bg-secondary text-primary-foreground text-base font-medium leading-6 rounded-[99px] neon-glow-blue hover:bg-secondary/90 transition-all duration-300"
            size="lg"
          >
            Signup for free
          </Button>
