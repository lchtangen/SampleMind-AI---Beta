  ...
  return (
    <section
      className="flex flex-col items-center text-center relative mx-auto rounded-2xl overflow-hidden my-6 py-0 px-4
         w-full h-[400px] md:w-[1220px] md:h-[600px] lg:h-[810px] md:px-0 neon-border"
    >
      {/* SVG Background */}
        ...
        >
          <g clipPath="url(#clip0_186_1134)">
            ...
            <g mask="url(#mask0_186_1134)">
              ...
              <rect x="699.711" y="81" width="36" height="36" fill="#8B5CF6" fillOpacity="0.3" />
              <rect x="195.711" y="153" width="36" height="36" fill="#10B981" fillOpacity="0.3" />
              <rect x="1023.71" y="153" width="36" height="36" fill="#3B82F6" fillOpacity="0.3" />
              <rect x="123.711" y="225" width="36" height="36" fill="#8B5CF6" fillOpacity="0.3" />
              <rect x="1095.71" y="225" width="36" height="36" fill="#10B981" fillOpacity="0.3" />
              <rect x="951.711" y="297" width="36" height="36" fill="#3B82F6" fillOpacity="0.3" />
              <rect x="231.711" y="333" width="36" height="36" fill="#8B5CF6" fillOpacity="0.3" />
              <rect x="303.711" y="405" width="36" height="36" fill="#10B981" fillOpacity="0.3" />
              <rect x="87.7109" y="405" width="36" height="36" fill="#8B5CF6" fillOpacity="0.3" />
              <rect x="519.711" y="405" width="36" height="36" fill="#3B82F6" fillOpacity="0.3" />
              <rect x="771.711" y="405" width="36" height="36" fill="#8B5CF6" fillOpacity="0.3" />
              <rect x="591.711" y="477" width="36" height="36" fill="#10B981" fillOpacity="0.3" />
            </g>
          ...
          <rect x="0.5" y="0.5" width="1219" height="809" rx="15.5" stroke="#8B5CF6" strokeOpacity="0.4" />
          ...
          <defs>
            ...
            >
              <stop stopColor="#0A0A0F" stopOpacity="0" />
            ...
            >
              ...
              <stop offset="0.578125" stopColor="#3B82F6" />
            ...
            >
              <stop stopColor="#8B5CF6" />
              <stop offset="0.157789" stopColor="#3B82F6" />
              <stop offset="1" stopColor="#10B981" />
            </radialGradient>
            <clipPath id="clip0_186_1134">
              <rect width="1220" height="810" rx="16" fill="#0A0A0F" />
            </clipPath>
          </defs>
        </svg>
      </div>
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        <h1 className="text-foreground text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight neon-text">
      ...
      <Link href="https://vercel.com/home" target="_blank" rel="noopener noreferrer">
        <Button className="relative z-10 bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-3 rounded-full font-medium text-base neon-glow transition-all duration-300 hover:neon-glow-blue">
          Signup for free
        </Button>
      </Link>
    </section>
