...
export function CTA() {
  ...
  return (
    <section id="cta" ref={ref} className="py-20 sm:py-32 bg-bg-secondary relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Join 10,000+ producers already using AI to create better music faster
          </motion.p>
          ...
          >
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              ...
              <span className="text-text-primary font-semibold">14-day free trial</span>
            </div>
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              <svg className="w-6 h-6 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-text-primary font-semibold">No credit card required</span>
            </div>
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              <svg className="w-6 h-6 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-text-primary font-semibold">Cancel anytime</span>
            </div>
          </motion.div>
