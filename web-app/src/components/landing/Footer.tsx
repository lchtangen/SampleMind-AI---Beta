  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'GitHub', href: 'https://github.com/lchtangen/SampleMind-AI---Beta' },
      ],
    },
    {
      title: 'Legal',
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-text-secondary mb-6 max-w-sm">
              AI-powered music production platform trusted by thousands of creators worldwide.
            </p>
        ...
        <div className="py-6 border-t border-primary/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-text-muted text-sm text-center md:text-left">
              © {currentYear} SampleMind AI. All rights reserved.
            </p>
