  ...
  const steps = [
    {
      ...
      title: "Upload",
      description:
        "Drag and drop your audio files or import entire folders. Supports all major formats.",
      icon: (
        <svg
          className="w-16 h-16"
          fill="none"
    ...
    },
    {
      ...
      title: "Analyze",
      description:
        "Our AI processes your samples, extracting tempo, key, mood, and 30+ audio features automatically.",
      icon: (
        <svg
          className="w-16 h-16"
          fill="none"
    ...
    },
    {
      ...
      title: "Organize",
      description:
        "Smart tags, categories, and collections are created automatically. Search and filter instantly.",
      icon: (
        <svg
          className="w-16 h-16"
          fill="none"
    ...
    },
    {
      ...
      title: "Create",
      description:
        "Start producing with AI-powered insights, recommendations, and tools to accelerate your workflow.",
      icon: (
        <svg
          className="w-16 h-16"
          fill="none"
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Get started in minutes. Our intuitive workflow makes professional
